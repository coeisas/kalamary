 ...
 * @author ArcoSoft-Pc1
 */
@Named(value = "informeProductosClientesMB")
@SessionScoped
public class InformeProductosClientesMB implements Serializable {
    ...
    /**
     * Creates a new instance of InformeProductosClientesMB
     */
    public InformeProductosClientesMB() {
    }
    ...
    public void generarReporte() throws IOException, JRException {
        ...
        try (ServletOutputStream servletOutputStream = httpServletResponse.getOutputStream()) {
            ...
            String ruta ;
                ruta = servletContext.getRealPath("/informes/reportes/informeDeVentasProductosCliente.jasper");
    ...
    public void generarReporteCSV()  {
        ...
        try{
            ...
            String url =  baseURL +"/ReportesCSV?tipo=productoClientes&producto="+(codigoProducto!=null?codigoProducto:"")+"&sede="+sedeActual.getIdSede();
