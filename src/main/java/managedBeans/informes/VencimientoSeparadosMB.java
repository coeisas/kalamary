 ...
 * @author ArcoSoft-Pc1
 */
@Named(value = "vencimientoSeparadosMB")
@SessionScoped
public class VencimientoSeparadosMB implements Serializable {
    ...
    /**
     * Creates a new instance of VencimientoSeparadosMB
     */
    public VencimientoSeparadosMB() {
    }
    ...
    public void generarReporte() throws IOException, JRException {
        ...
        try (ServletOutputStream servletOutputStream = httpServletResponse.getOutputStream()) {
            ...
            String ruta ;
                ruta = servletContext.getRealPath("/informes/reportes/vencimientosSeparados.jasper");
    ...
    public void generarReporteCSV()  {
        ...
        try{
            ...
            String url =  baseURL +"/ReportesCSV?tipo=vencimientosSeparados&sede="+sedeActual.getIdSede();
