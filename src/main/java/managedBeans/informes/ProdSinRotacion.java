 ...
 * @author ArcoSoft-Pc1
 */
@Named(value = "prodSinRotacion")
@SessionScoped
public class ProdSinRotacion implements Serializable {
    ...
    /**
     * Creates a new instance of ProdSinRotacion
     */
    public ProdSinRotacion() {
    }
    ...
    public void generarReporte() throws IOException, JRException {
        ...
        try (ServletOutputStream servletOutputStream = httpServletResponse.getOutputStream()) {
            ...
            String ruta ;
                ruta = servletContext.getRealPath("/informes/reportes/productosSinrotacion.jasper");
    ...
    public void generarReporteCSV()  {
        ...
        try{
            ...
            String url =  baseURL +"/ReportesCSV?tipo=productosSinRotacion&sede="+sedeActual.getIdSede();
