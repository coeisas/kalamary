 ...
 * @author ArcoSoft-Pc1
 */
@Named(value = "informeServiciosMB")
@SessionScoped
public class InformeServiciosMB implements Serializable {
    ...
    /**
     * Creates a new instance of InformeServiciosMB
     */
    public InformeServiciosMB() {
    }
    ...
    public void generarReporte() throws IOException, JRException {
        ...
        try (ServletOutputStream servletOutputStream = httpServletResponse.getOutputStream()) {
            ...
            String ruta ;
                ruta = servletContext.getRealPath("/informes/reportes/informeDeServicios.jasper");
    ...
    public void generarReporteCSV()  {
        ...
        try{
            ...
            String url =  baseURL +"/ReportesCSV?tipo=servicios&producto="+(codigoProducto!=null?codigoProducto:"")+"&sede="+sedeActual.getIdSede();
