 ...
 * @author ArcoSoft-Pc1
 */
@Named(value = "informeProductosMB")
@SessionScoped
public class InformeProductosMB implements Serializable {
    ...
    /**
     * Creates a new instance of InformeProductosMB
     */
    public InformeProductosMB() {
    }
    ...
    public void generarReporte() throws IOException, JRException {
        ...
        try (ServletOutputStream servletOutputStream = httpServletResponse.getOutputStream()) {
            ...
            String ruta ;
                ruta = servletContext.getRealPath("/informes/reportes/informeProductos.jasper");
    ...
    public void generarReporteCSV()  {
        ...
        try{
            ...
            String url =  baseURL +"/ReportesCSV?tipo=productosA&producto="+(codigoProducto!=null?codigoProducto:"")+"&sede="+sedeActual.getIdSede();
