 ...
 * @author mario
 */
public class LazyFacturaEspecialDataModel extends LazyDataModel<FacDocumentosmaster> {
    ...
    public LazyFacturaEspecialDataModel(FacDocumentosmasterFacade documentosmasterFacade, CfgEmpresasede sede) {
        this.documentosmasterFacade = documentosmasterFacade;
        this.sede = sede;
    }

    public LazyFacturaEspecialDataModel(FacDocumentosmasterFacade documentosmasterFacade, CfgEmpresasede sede, CfgCliente cliente, Calendar fechaIncial, Calendar fechaFinal, int numFactura) {
        this.documentosmasterFacade = documentosmasterFacade;
        this.sede = sede;
    ...
    private List<FacDocumentosmaster> loadDocuementoMaster(int first, int pageSize, Map<String, Object> filters) {
        List<FacDocumentosmaster> data;
        data = documentosmasterFacade.buscarFacturasEspecialBySedeLazy(sede, cliente, numFactura, fechaIncial, fechaFinal, first, pageSize);
        this.setRowCount(documentosmasterFacade.totalFacturasEspecialBySede(sede, cliente, numFactura, fechaIncial, fechaFinal));
        return data;
    }
}
